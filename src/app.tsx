    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-zinc-300 text-lg">Convide seus amigos e planeje sua própria viajem!</p>
        </div>
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className='space-y-2'>
              ...
              <p className="text-sm text-zinc-400">
                Os convidados irão receber e-mails para participação na viajem.
              </p>
            </div>
            ...
            <div className='w-full h-px bg-zinc-800' />
              ...
              <form onSubmit={addNewEmailToInvite} className="p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2">
                ...
                <button type='submit' className="bg-lime-380 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400">
                  Convidar
